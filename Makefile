...
all:
	...
	g++ $(OPT) -std=c++14 *.o -o dot_game.bin $(SFML_LIBS) -I SFMLGame/ -I SFMLGame/SFML-2.5.1/include/ -I SFMLGame/tmxlite/include -I SFMLGame/lua5.3.5

debug:  
	g++ -g -std=c++14 -c SFMLGame/*.cpp -I SFMLGame/ $(SFML_INCL) -I SFMLGame/tmxlite/include -I SFMLGame/lua5.3.5
	g++ -std=c++14 *.o -o dot_game.bin $(SFML_LIBS)

game:
	g++ $(OPT) -std=c++14 -c SFMLGame/*.cpp -I SFMLGame/ $(SFML_INCL) -I SFMLGame/tmxlite/include -I SFMLGame/lua5.3.5

link:
	g++ $(OPT) -std=c++14 *.o -o dot_game.bin $(SFML_LIBS)
