...
function Resources:load_assets()
  local textures = {
    ...
    { key = "tiles",        path = "games/cards/assets/textures/tiles.png" },
    { key = "effects",      path = "games/cards/assets/textures/effects.png" },
    { key = "gui",          path = "games/cards/assets/textures/gui.png" },
    { key = "card",         path = "games/cards/assets/cards/images/2ed_40.png", smooth = true},
  }

  local sounds = {
    { key = "fire",         path = "games/cards/assets/sounds/fire.wav" },
  }

  local music = {
    { key = "adagio",       path = "games/cards/assets/music/adagio.wav" },
  }
