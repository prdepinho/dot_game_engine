...
#define FAST_A_STAR_LOOP
	...
	std::stack<sf::Vector2i> search(std::vector<bool> graph, unsigned int column_count, sf::Vector2i start, sf::Vector2i end, unsigned int limit = 200, bool ignore_obstacles = false);
